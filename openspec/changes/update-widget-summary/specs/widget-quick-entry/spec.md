...
The app SHALL provide Home Screen widgets (small and medium) showing three whole-dollar spending totals — the calendar day (most prominent), the calendar month, and the calendar year containing the current moment — updating when expenses change and at day rollover. The widget SHALL display a small vector flame mark. The widget SHALL be outlined in light green when today's total is $0 and in red otherwise. Tapping the widget outside any button SHALL open the app directly to the amount keypad.
