...
enum SquanderSchemaV1: VersionedSchema {
...
typealias Expense = SquanderSchemaV1.Expense
typealias Category = SquanderSchemaV1.Category
typealias LabelMapping = SquanderSchemaV1.LabelMapping

enum SquanderMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] { [SquanderSchemaV1.self] }
